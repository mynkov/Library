...
namespace Library.Web.Controllers
{
    public partial class CultureController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected CultureController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CultureController Actions { get { return MVC.Culture; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Culture";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Culture";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CultureController : Library.Web.Controllers.CultureController
    {
        public T4MVC_CultureController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ChangeCultureOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string culture);

        [NonAction]
        public override System.Web.Mvc.ActionResult ChangeCulture(string culture)
        {
            ...
            ChangeCultureOverride(callInfo, culture);
            return callInfo;
        }
