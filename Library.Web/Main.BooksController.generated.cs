...
namespace Library.Web.Areas.Main.Controllers
{
    public partial class BooksController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public BooksController Actions { get { return MVC.Main.Books; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Main/Views/Books/Create.cshtml";
            public readonly string Delete = "~/Areas/Main/Views/Books/Delete.cshtml";
            public readonly string Details = "~/Areas/Main/Views/Books/Details.cshtml";
            public readonly string Edit = "~/Areas/Main/Views/Books/Edit.cshtml";
            public readonly string Index = "~/Areas/Main/Views/Books/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BooksController : Library.Web.Areas.Main.Controllers.BooksController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Library.BusinessLayer.Entities.Book book);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Library.BusinessLayer.Entities.Book book)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Library.BusinessLayer.Entities.Book book);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Library.BusinessLayer.Entities.Book book)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "book", book);
